    ...
    return (
        <>
            ...
            <section style={{ position: 'relative', minHeight: '70vh', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
                <div className="glow-orb" style={{ width: 500, height: 500, top: '-5%', right: '10%', background: 'rgba(52,211,153,0.08)' }} />
                <div className="glow-orb" style={{ width: 400, height: 400, bottom: '0', left: '10%', background: 'rgba(139,92,246,0.08)' }} />
